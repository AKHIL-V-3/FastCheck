      ...
      <div className='w-full xl:h-96 h-full bg-white text-black flex justify-center pt-24 pb-16'>
        <div className='w-11/12 xl:flex justify-between xl:space-x-28 space-y-24 xl:space-y-0'>
          ...
          <div className='flex flex-col xl:w-3/12 items-start  mt-2'>
            <h1 className='text-lg font-bold mb-7'>COMPANY</h1>
          ...
          <div className='flex flex-col xl:w-3/12 items-start  mt-2'>
            <h1 className='text-lg font-bold mb-7'>HELP CENTER</h1>
            <div className='space-y-2'>
              <p>Find a Propertie</p>
              <p>How To Host?</p>
              <p>Why Us?</p>
              <p>FAQs</p>
              <p>Rental Guides</p>
          ...
          <div className='flex flex-col w-3/12 items-start  mt-2'>
            <h1 className='text-lg font-bold mb-7'>CONTACT INFO</h1>
            <div className='space-y-2'>
              <p>Phone:9876543210</p>
              <p>Email:company@gmail.com</p>
              <p>Location:100 Smart Street</p>
              
              <div className='flex space-x-3 pt-4'>
                           
              <div className='bg-white w-5 h-5 rounded-md flex justify-center items-center'>
