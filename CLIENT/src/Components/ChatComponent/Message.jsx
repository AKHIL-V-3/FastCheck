            ...
            <div className='bg-green-50 w-full h-screen fixed '>
                ...
                <div className='w-full h-screen flex justify-start'>
                    ...
                    <div className='w-full  mb-5 bg-white z-30 shadow-lg shadow-balck flex overscroll-y-auto'>
                        <div className='w-4/12 h-auto border-e-2 border-gray-800'>
                            <div className='border-e-2 border-gray-800'>
                                <div className='w-full h-16 bg-stone-200 flex items-center '>
                                    <div className='bg-white w-12 h-12 border border-gray-800 rounded-full ms-2 bg-cover' style={{ backgroundImage: "url('https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png')" }} >
                                    </div>
                                </div>
                            </div>
                        ...
                        {currentChat ?
                            ...
                            <div className='w-8/12 relative'>
                                ...
                                < div className='w-full h-16 bg-stone-200 flex items-center text-black '>

                                    <div className='bg-white border border-gray-800 w-12 h-12 rounded-full ms-2 bg-cover' style={{ backgroundImage: "url('https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png')" }}>
                                ...
                                <div className='bg-green-50 w-full h-14 absolute bottom-7 text-black left-0 right-0 flex items-center'>
                            ...
                            <div className='w-8/12 relative bg-white'>


                                <div className='w-full h-full '>
                                    <div className='flex  w-full h-full justify-center items-center'>
                                        <div className='text-5xl font-bold opacity-25 '> Open a conversation to start a chat
