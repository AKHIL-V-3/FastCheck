                ...
                <div className='w-11/12'  >
                    <div className='flex justify-between'>
                        ...
                        <div className='flex space-x-6 items-center'>
                            ...
                            <div>
                                <select id="countries" onChange={filterReservation} className=" border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    reservations.map((Hotel) => (
                                        <div>
                                            ...
                                            <div className='flex flex-col space-y-1 mt-3'>
                                                ...
                                                {Hotel.Booking === "Booked" ? <button onClick={() => cancelReservation(Hotel._id)} className='bg-white text-black  font-bold uppercase text-xs px-3 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none  ease-linear transition-all duration-150'>Cancel Reservation</button> : <button className='bg-gray-400 text-gray-800  font-bold uppercase text-xs px-3 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none  ease-linear transition-all duration-150'>Cancel Reservation</button>}
                                            </div>
                                        </div>
                                    ))
                                }
